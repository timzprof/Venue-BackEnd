...
before((done) => {
  server.on('DBConnected', () => {
    userModel
      ...
      .catch((err) => console.log('Auth Test - Creating Fake user failed', err.message || err));
  });
});
...
describe('Auth Tests', () => {
  ...
  it('User Not Found Error', (done) => {
    chai
      ...
      .catch((err) => console.log('Auth Login Test(User Not Found) - ', err.message));
  });
  it('Incorrect Password Error', (done) => {
    chai
      ...
      .catch((err) => console.log('Auth Login Test(Incorrect Password) - ', err.message));
  });
...
after((done) => {
  userModel
    ...
    .catch((err) => console.log('Auth Test - Deleting Fake user failed', err));
});
